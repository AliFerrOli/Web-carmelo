...
<body>
    ...
    <section class="areaEstilizada">
        ...
        <div class="tituloTopoArea">
            <div class="textoTopo">
                <a class="setaVoltar" href="admEnderecos.php">
                ...
                <p class="tituloCadastro">CADASTRO Endereco</p>
            </div>
            </div>
            ...
            <div class="areaCadastroCaixa">
                ...
                <form action="Enderecos/criarEndereco.php" class="admCadastros" method="post" enctype="multipart/form-data">
                    <label>Nome do Endereco</label>
                    <input type="text" name="nome" required>

                    <label>Descrição</label>
                    <textarea name="descricao" id="descEndereco" cols="30" rows="10"></textarea>
